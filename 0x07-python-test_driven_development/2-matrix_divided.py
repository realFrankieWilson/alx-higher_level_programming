#!/usr/bin/python3
"""
The module is about dividing a matrix
...
def matrix_divided(matrix, div):
    """
    The function divides all elements of a matrix by a given
    number.
    ...
    Returns:
        A new matrix after the division
    ...
    if (not isinstance(matrix, list) or matrix == [] or
            ...
            not all((isinstance(elem, int) or isinstance(elem, float))
                    for elem in [digit for row in matrix for digit in row])):
