...
class Square:
    ...
    def position(self, value):
        ...
        Args: value as a tuple of two position integers
        Raises:
            TypeError: if value isnot a tuple or and value < 0
        """
        if not isinstance(value, tuple):
            raise TypeError("position must be a tuple of 2 positive integers")
        if len(value) != 2:
            raise TypeError("position must be a tuple 2 positive integers")
